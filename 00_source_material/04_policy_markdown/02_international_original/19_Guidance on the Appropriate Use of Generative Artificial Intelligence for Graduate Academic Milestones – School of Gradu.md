# Policy Text: 19_Guidance on the Appropriate Use of Generative Artificial Intelligence for Graduate Academic Milestones – School of Gradu

## Provenance
- Source file: `00_source_material/02_international_original/19_Guidance on the Appropriate Use of Generative Artificial Intelligence for Graduate Academic Milestones – School of Gradu.html`
- Source SHA256: `8525eddbbc7a8d73fb8f6510bcabecf6096e4b721a76c9bd75ebb2da5b5cca6b`
- Source type: `html`
- Extracted at (UTC): `2026-03-01T12:13:59.661372+00:00`
- Extraction method: `semantic:main`
- Dataset link: `S2`
- Dataset row id: `18`
- Institution: `University of Toronto`
- Source URL: `https://www.sgs.utoronto.ca/about/guidance-on-the-use-of-generative-artificial-intelligence/`
- Snapshot filename (dataset): `19_Guidance on the Appropriate Use of Generative Artificial Intelligence for Graduate Academic Milestones – School of Gradu.html`
- Policy scope (dataset): ``
- Release date (dataset): `2025/9/5`
...
In response to the rapidly evolving landscape of generative artificial intelligence (AI) [1] use in academic and educational settings, this preliminary guidance has been produced to address frequently asked questions ( FAQ ) in the context of graduate academic milestones at the University of Toronto, including the completion of comprehensive exams, candidacy requirements, language requirements, the doctoral thesis, and the final oral examination. More detailed guidance on this topic, as well as new or updated policies may be issued in future, in which case this preliminary guidance will also be updated. The FAQ s below outline important considerations for graduate students, supervisors, supervisory committees, and graduate units on the use of generative AI tools in graduate student research, thesis writing, and other key academic milestones while upholding the core principles of academic quality, research integrity, and transparency. The FAQ s cover requirements both for approval and for documentation of the use of generative AI tools in graduate-level scholarly activities, as well as risks and other considerations in using generative AI in graduate-level scholarly activities.
...
### Who is responsible for AI-generated content used in research or other scholarly work?
...
### Can students use generative AI tools to research or write a doctoral thesis?
...
### If generative AI tools are allowed for research, does that mean they are also allowed for writing?
...
### Can students use generative AI tools to edit a doctoral thesis?
...
### Can students use generative AI tools to research, write, or edit a master’s thesis or Major Research Paper, or in other scholarly activities required to meet graduate academic milestones?
...
The Code of Behaviour on Academic Matters , Policy on Ethical Conduct in Research and Framework to Address Allegations of Research Misconduct also apply to master’s research, theses, Major Research Papers, and other graduate-level scholarly activities required to meet academic milestones including qualifying and comprehensive exams, candidacy requirements, language requirements, and the final oral examination. Faculties and graduate units should issue specific guidance on the use of generative AI in such graduate-level scholarly activities. The F AQs and guidance on syllabi and assignments issued by the Office of the Vice-Provost, Innovations in Undergraduate Education may be more relevant in the context of some papers or projects, and also apply to the undergraduate context.

### Can graduate students use generative AI as a research tool?
...
### How should students describe and reference generative AI tools?
...
### Could the use of generative AI hinder the development of graduate writing skills?
...
### Are generative AI tools accurate enough for use in graduate research and writing?
...
- U of T Information Security: Use artificial intelligence intelligently

- U of T Information Security: Information risk assessment

- U of T CTSI: Teaching tools criteria checklist

### Can generative AI tools be used in works submitted for publication?
...
### What are the copyright and intellectual property implications of using generative AI tools?
...
Sarah Sharma Acting Vice Dean, Research & Program Innovation sgs.vdeanprograms@utoronto.ca Graduate Program Completion Office Doctoral: Coordinator, Graduate Program Completion, sgs.doctoral@utoronto.ca Master’s: Program Completion Officer, Master’s, sgs.masters@utoronto.ca

### Return to the SGS homepage
