# Policy Text: 84_Policy on the use of AI tools in classes _ utelecon

## Provenance
- Source file: `00_source_material/02_international_original/84_Policy on the use of AI tools in classes _ utelecon.html`
- Source SHA256: `3545bd5d7da5512228792880a3db2a30ccd93b15149c6b949e42dc73565304f6`
- Source type: `html`
- Extracted at (UTC): `2026-03-01T12:14:08.231222+00:00`
- Extraction method: `special:id-article`
- Dataset link: `S2`
- Dataset row id: `76`
- Institution: `University of Tokyo`
- Source URL: `https://utelecon.adm.u-tokyo.ac.jp/en/docs/ai-tools-in-classes/`
- Snapshot filename (dataset): `84_Policy on the use of AI tools in classes _ utelecon.html`
- Policy scope (dataset): ``
- Release date (dataset): `2023/4/28`
...
can I design my assignments to facilitate students generating their own work?” https://www.cmu.edu/teaching/technology/aitools/index.html )
